...
<div class="card-grid">
  ...
  <a href="rules-rp.html" class="card" style="text-decoration:none;color:inherit;"><div class="card-title">🎭 RPルール</div><p style="color:var(--text-dim);">ロールプレイ全般に関するルール</p></a>
  ...
  <a href="rules-relationship.html" class="card" style="text-decoration:none;color:inherit;"><div class="card-title">💕 恋愛RP</div><p style="color:var(--text-dim);">恋愛RPのトラブル防止ガイドライン</p></a>
  ...
  <a href="nicole.html" class="card" style="text-decoration:none;color:inherit;"><div class="card-title">🌹 Nicole</div><p style="color:var(--text-dim);">ジョイント・食べ物・飲み物</p></a>
</div>
"""
